# Generated by Powerlevel10k configuration wizard on 2024-06-15 at 08:41 WIB.
...
# round separators, round heads, flat tails, 2 lines, dotted, full frame, sparse,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=gray
  # Custom icon.
